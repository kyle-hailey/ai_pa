...
client = OpenAI(api_key="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")  # or use os.getenv("OPENAI_API_KEY")
...
solution 3
   ...
   - The number of buckets should typically be small (3–8) to keep UNION queries manageable.
